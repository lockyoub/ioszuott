...
extension StockEntity {
    ...
    /// 更新股票价格数据 - 使用高精度NSDecimalNumber
    func updatePrice(price: NSDecimalNumber, 
    ...
    /// 更新盘口数据 - 使用高精度NSDecimalNumber
    func updateOrderBook(bidPrices: [NSDecimalNumber], 
                        bidVolumes: [Int64],
    ...
    var bidPricesArray: [NSDecimalNumber] {
        ...
        return prices.map { NSDecimalNumber(value: $0) }
    }
